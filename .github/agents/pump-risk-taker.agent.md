...
2. **Скан.** Методика `spot-momentum-scan-validate`: топ USDT-пар по обороту → закрытые свечи 1H → фильтры: свеча ≥ +1.5–2%, объём ≥ 1.5–2× среднего за 20, RSI в рабочем окне, пара ликвидна. Идеи сигналов — `speed-hunter`, но **без его плеча** (только спот, если карман не разрешает иное).
